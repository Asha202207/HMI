package com.goldwind.javafxboot.protocol.modbus.domain.command;
...
import com.goldwind.javafxboot.protocol.modbus.domain.ModbusPacketInterface;
...
import com.goldwind.javafxboot.protocol.modbus.domain.datatype.numeric.SingleCommandCoilValue;
